...
export async function Navbar() {
  ...
  return (
    <>
      {/* Desktop / tablet */}
      <header className="fixed inset-x-4 top-5 z-40 mx-auto hidden max-w-6xl items-center justify-between gap-4 rounded-xl bg-white/40 px-4 py-2 shadow-sm backdrop-blur-md md:flex">
      ...
      {/* Mobile: language switcher top right, navigation as a bottom bar */}
      <LanguageSwitcher
        locale={locale}
        label={dict.nav.language}
        className="fixed right-3 top-3 z-40 shadow-sm backdrop-blur-md md:hidden"
      />
