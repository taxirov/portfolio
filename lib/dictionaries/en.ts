...
const en = {
  ...
  domains: {
    ...
    intro: "Domains I own and am ready to sell. Send an offer and I will reply by email.",
    metaDescription: "Domain names for sale by Saad Takhir. Send an offer.",
    all: "All domains",
    empty: "No domains for sale right now.",
    price: "Price",
    noPrice: "Open to offers",
    sold: "Sold",
    makeOffer: "Make an offer",
    offerTitle: "Offer for {domain}",
    yourOffer: "Your offer ({currency})",
    optional: "optional",
    message: "Message",
    messagePlaceholder: "How would you like to use the domain? Any questions?",
    close: "Close",
    offerRequired: "Enter an offer amount or a message.",
    offerInvalid: "Enter a whole number greater than zero.",
    unavailable: "This domain is no longer for sale.",
    thanks: "Thank you! Your offer for {domain} has been sent.",
  },
  about: {
    title: "About",
    fullName: "Full name",
